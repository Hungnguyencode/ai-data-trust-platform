...
def test_pipeline_run_history_by_catalog_scopes_query(
    monkeypatch: pytest.MonkeyPatch,
):
    connection = FakeConnection(
        []
...
def test_pipeline_run_history_by_catalog_rejects_invalid_catalog_id(
    catalog_id,
):
    with pytest.raises(
        ValueError,
        ...
        repository.get_pipeline_run_history_by_catalog(
